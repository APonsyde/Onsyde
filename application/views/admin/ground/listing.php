...
<div class="bg-body-light border-b">
    <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
            ...
            <span class="breadcrumb-item active">Grounds</span>
        </nav>
    </div>
</div>
...
<div class="row gutters-tiny">
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow">
            <div class="block-content block-content-full block-sticky-options">
                ...
                <div class="font-size-h2 font-w700 mb-0 text-info" data-toggle="countTo" data-to="<?php echo $total; ?>">0</div>                    <div class="font-size-sm font-w600 text-uppercase text-muted">All grounds</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow" href="<?php echo site_url('ground/add'); ?>">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                ...
                <div class="py-20 text-center">
                    ...
                    <div class="font-size-sm font-w600 text-uppercase text-muted">New Ground</div>
                </div>
            </div>
        </a>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="search" value="<?php echo $this->input->get('search'); ?>" placeholder="Search grounds by ID, name..">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo site_url('ground/listing'); ?>" class="btn btn-alt-danger btn-block mb-4">
                                Clear
                            </a>
                        </div>
                    </div>
            ...
            <table class="table table-striped table-vcenter">
                <thead>
                    <tr class="border-double text-center">
                        ...
                        <?php 
                        $sort_icon = "fa-unsorted";
                        if($this->input->get('sort') == "pincode=asc")
                            $sort_icon = "fa-sort-asc";
                        else if($this->input->get('sort') == "pincode=desc")
                            $sort_icon = "fa-sort-desc";
                        ?>
                        <th class="sort" data-sort="<?php echo ($this->input->get('sort') == "pincode=asc") ? "pincode=desc" : "pincode=asc"; ?>">pincode&nbsp;&nbsp;<i class="fa <?php echo $sort_icon; ?>"></i></th>
                ...
                <tbody>
                    <?php if(!empty($grounds)) { ?>
                        <?php foreach($grounds as  $ground) { ?>
                            <tr class="text-center">
                                <th class="text-center" scope="row"><?php echo $ground['id']; ?></th>
                                <td><?php echo $ground['ground_name']; ?></td>
                                <td><?php echo $ground['pincode']; ?></td>
                                <td>
                                    <?php if($ground['inactive']) { ?>
                                        <span class="badge badge-danger">Inactive</span>
                                    <?php } else { ?>
                                        <span class="badge badge-success">Active</span>
                                    <?php } ?>
                                </td>
                                <td><?php echo convert_db_time($ground['created_on'], "d/m/Y H:i"); ?></td>
                                <td class="text-center">
                                    <a class="btn btn-sm btn-alt-primary mr-5 mb-5 fa" href="<?php echo site_url('ground/edit/'.$ground['id']); ?>">
                                        <i class="fa fa-eye mr-0"></i>
                                        View
                                    </a>
                                    <a class="btn btn-sm btn-alt-danger mr-5 mb-5 fa delete-banner" href="<?php echo site_url('ground/delete/'.$ground['id']); ?>">
                                        <i class="fa fa-trash fa mr-0"></i>
                                        Delete
                                    </a>
                                </td>
                    ...
                    <?php } else { ?>
                        <tr>
                            <td colspan="8">No grounds added / registered yet</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
