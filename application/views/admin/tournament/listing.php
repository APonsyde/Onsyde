...
<div class="bg-body-light border-b">
    <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
            ...
            <span class="breadcrumb-item active">Tournament</span>
        </nav>
    </div>
</div>
...
<div class="row gutters-tiny">
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow">
            <div class="block-content block-content-full block-sticky-options">
                ...
                <div class="font-size-h2 font-w700 mb-0 text-info" data-toggle="countTo" data-to="<?php echo $total; ?>">0</div>          <div class="font-size-sm font-w600 text-uppercase text-muted">All Tournaments</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow" href="<?php echo site_url('tournament/add'); ?>">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                ...
                <div class="py-20 text-center">
                    ...
                    <div class="font-size-sm font-w600 text-uppercase text-muted">New Tournament</div>
                </div>
            </div>
        </a>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="search" value="<?php echo $this->input->get('search'); ?>" placeholder="Search tournament by ID, name..">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo site_url('tournament/listing'); ?>" class="btn btn-alt-danger btn-block mb-4">
                                Clear
                            </a>
                        </div>
                    </div>
            ...
            <table class="table table-striped table-vcenter">
                <thead>
                    <tr class="border-double text-center">
                        ...
                        <?php 
                        $sort_icon = "fa-unsorted";
                        if($this->input->get('sort') == "Sport=asc")
                            $sort_icon = "fa-sort-asc";
                        else if($this->input->get('sort') == "Sport=desc")
                            $sort_icon = "fa-sort-desc";
                        ?>
                        <th class="sort" data-sort="<?php echo ($this->input->get('sort') == "Sport=asc") ? "Sport=desc" : "Sport=asc"; ?>">Sport &nbsp;&nbsp;<i class="fa <?php echo $sort_icon; ?>"></i></th>
                        <?php 
                        $sort_icon = "fa-unsorted";
                        if($this->input->get('sort') == "Ground=asc")
                            $sort_icon = "fa-sort-asc";
                        else if($this->input->get('sort') == "Ground=desc")
                            $sort_icon = "fa-sort-desc";
                        ?>
                        <th class="sort" data-sort="<?php echo ($this->input->get('sort') == "Ground=asc") ? "Ground=desc" : "Ground=asc"; ?>">Ground &nbsp;&nbsp;<i class="fa <?php echo $sort_icon; ?>"></i></th>
                        <?php 
                        $sort_icon = "fa-unsorted";
                ...
                <tbody>
                    <?php if(!empty($tournaments)) { ?>
                        <?php foreach($tournaments as  $tournament) { ?>
                            <tr class="text-center">
                                <th class="text-center" scope="row"><?php echo $tournament['id']; ?></th>
                                <td><?php echo $tournament['tournament_name']; ?></td>
                                <td><?php echo $tournament['sport']; ?></td>
                                <td><?php echo $tournament['ground']; ?></td>
                                <td>
                                    <?php if($tournament['inactive']) { ?>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-sm btn-alt-primary mr-5 mb-5 fa" href="<?php echo site_url('tournament/teams/'.$tournament['id']); ?>">
                                        <i class="fa fa-eye mr-5"></i>
                                        Show Teams
                                    </a>
                                    <a class="btn btn-sm btn-alt-primary mr-5 mb-5 fa" href="<?php echo site_url('tournament/edit/'.$tournament['id']); ?>">
                                        <i class="fa fa-eye mr-5"></i>
                                        View
                                    </a>
                                    <a class="btn btn-sm btn-alt-danger mr-5 mb-5 fa delete-banner" href="<?php echo site_url('tournament/delete/'.$tournament['id']); ?>">
                    ...
                    <?php } else { ?>
                        <tr>
                            <td colspan="8">No tournaments added / registered yet</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
