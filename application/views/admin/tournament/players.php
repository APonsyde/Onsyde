                ...
                <div class="col-md-12">
                    <div class="block block-rounded block-themed">
                        <div class="block-header bg-gd-primary">
                            <h3 class="block-title">Individual Players</h3>
                            <div class="block-options">
                                <a class="btn btn-md btn-alt-primary " href="<?php echo site_url('tournament/create_team/'.$tournament['id']); ?>"> + Create new team
                                </a>
                            </div>
                        </div>
                        <div class="block-content block-content-full">
                            <h5> Individual Players :  </h2>
                                <div class="table-responsive">
                                    <table class="table table-striped table-vcenter">
                                        ...
                                        <tbody>
                                            <?php if(!empty($individual_players)) { ?>
                                                <?php foreach($individual_players as  $individual_player) { ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $individual_player['id']; ?></th>
                                                        <th  scope="row"><?php echo str_replace("", null, $individual_player['name']); ?></th>
                                                    </tr>         
                                                <?php } ?>
                                            <?php } else { ?>
                                                <tr>
