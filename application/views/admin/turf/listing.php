...
<div class="bg-body-light border-b">
    <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
            ...
            <span class="breadcrumb-item active">Turfs</span>
        </nav>
    </div>
</div>
...
<div class="row gutters-tiny">
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow">
            <div class="block-content block-content-full block-sticky-options">
                ...
                <div class="font-size-h2 font-w700 mb-0 text-info" data-toggle="countTo" data-to="<?php echo $total; ?>">0</div>                    <div class="font-size-sm font-w600 text-uppercase text-muted">All Turfs</div>
                </div>
            </div>
        </a>
    </div>
    ...
    <div class="col-md-6 col-xl-4">
        <a class="block block-rounded block-link-shadow" href="<?php echo site_url('turf/add'); ?>">
            <div class="block-content block-content-full block-sticky-options">
                <div class="block-options">
                    <div class="block-options-item">
                ...
                <div class="py-20 text-center">
                    ...
                    <div class="font-size-sm font-w600 text-uppercase text-muted">New Turf</div>
                </div>
            </div>
        </a>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="search" value="<?php echo $this->input->get('search'); ?>" placeholder="Search turf by ID, name..">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo site_url('turf/listing'); ?>" class="btn btn-alt-danger btn-block mb-4">
                                Clear
                            </a>
                        </div>
                    </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-vcenter">
                ...
                <tbody>
                    <?php if(!empty($turfs)) { ?>
                        <?php foreach($turfs as  $turf) { ?>
                            <tr class="text-center">
                                <th class="text-center" scope="row"><?php echo $turf['id']; ?></th>
                                <td><?php echo $turf['turf_name']; ?></td>
                                <td>
                                ...
                                <td><?php echo convert_db_time($turf['created_on'], "d/m/Y H:i"); ?></td>
                                <td class="text-center">
                                    <a class="btn btn-sm btn-alt-primary mr-5 mb-5 fa" href="<?php echo site_url('turf/edit/'.$turf['id']); ?>">
                                        <i class="fa fa-eye mr-0"></i>
                                        View
                                    </a>
                                    <a class="btn btn-sm btn-alt-danger mr-5 mb-5 fa delete-banner" href="<?php echo site_url('turf/delete/'.$turf['id']); ?>">
                    ...
                    <?php } else { ?>
                        <tr>
                            <td colspan="8">No turfs added yet</td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
