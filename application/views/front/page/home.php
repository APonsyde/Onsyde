<div class="container turfBanner">
      ...
      <form>
        <div class="search-box">
           <div class="flexpanel">
             ...
             <!--  <div class="date">I’m looking to play on</div>
                  <ul class="searchDate">
                      <li>ffvfvfv</li>
                      <li>frfrfr</li>
                      <li>frfrf</li>
                  ...
                  <div class="btn-search">
                      <a href="#" class="btn btn-simple">Find Turfs →</a>
                  </div>
              </div>
          </div>
...
<section class="main-block green">
...
<div class="col-md-6">
    <figure class="pos"><img src="images/gardner.jpg" class="wid100"></figure>
</div>
</div>
</div>
</div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="btn-wrap btn-wrap2">
              <a href="add-listing.html" class="btn btn-simple">Know More →</a>
          </div>
      </div>
  </div>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="btn-wrap">
          <a href="blog.html" class="btn btn-simple">Visit Blog Section →</a>
      </div>
  </div>
</div>
</div>
