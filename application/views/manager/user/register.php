                                ...
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="company_name" placeholder="Company name" value="<?php echo $this->input->post('company_name'); ?>">
                                            <?php echo form_error('company_name'); ?>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="contact_person" placeholder="Contact person" value="<?php echo $this->input->post('contact_person'); ?>">
