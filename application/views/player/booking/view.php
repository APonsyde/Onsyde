<div class="booking manager-dashboard mr-5">
    ...
    <?php if($booking['status'] == TURF_STATUS_BOOKED) { ?>
        ...
        <?php if($this->player['id'] == $booking['player_id']) { ?>
            ...
            <?php } ?>
        <?php } ?>
        <h6 class="page-title mb-3">Booking URL - <code id="bookingUrl" style="cursor: pointer;" onclick="copy_to_clipboard('#bookingUrl')"><?php echo site_url('booking/view/'.$booking['booking_key']); ?></code> <button class="greyBtn green ml-3" style="cursor: pointer;" onclick="copy_to_clipboard('#bookingUrl')">Copy</button></h6>
    <?php } ?>
</div>
